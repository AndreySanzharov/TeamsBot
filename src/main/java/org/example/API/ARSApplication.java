...
//    private static final String NAME = "SanzarovAA";
//    private static final String PASSWORD = "333-AAA-bbb";
//
//
////    static ARSConnector ars = new ARSConnector();
//    private static final ARServerUser server = new ARServerUser();
//
//
//    public static void main(String[] args) throws ARException {
//        connect(SERVER, NAME, PASSWORD);
//        createIncident("7", "7", "desc", "info", "AA", "SS", "AA", "lukoil", "Инцидент");
//
//    }
//
